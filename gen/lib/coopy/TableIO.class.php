...
class coopy_TableIO {
	...
	public function valid() { if(!php_Boot::$skip_constructor) {
		return true;
	}}
	...
	public function sendToBrowser($html) {
		haxe_Log::trace("do not know how to send to browser in this language", _hx_anonymous(array("fileName" => "TableIO.hx", "lineNumber" => 189, "className" => "coopy.TableIO", "methodName" => "sendToBrowser")));
	}
