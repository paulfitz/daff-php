...
class harness_MergeTest extends haxe_unit_TestCase {
	...
	public function setup() {
		...
		$this->data4 = (new _hx_array(array((new _hx_array(array("Country", "Code", "Capital"))), (new _hx_array(array("Dear old Ireland", "ie", "Dublin"))), (new _hx_array(array("Spain", "es", "Madrid"))), (new _hx_array(array("Germany", "de", "Berlin"))), (new _hx_array(array("Finland", null, "Helsinki"))))));
		...
		$this->data4b = (new _hx_array(array((new _hx_array(array("Country", "Code", "Capital"))), (new _hx_array(array("Dear old Ireland", "ie", "Dublin"))), (new _hx_array(array("Spain", "es", "((( Barcelona ))) Madrid /// Lisbon"))), (new _hx_array(array("Germany", "de", "Berlin"))), (new _hx_array(array("Finland", null, "Helsinki"))))));
	}
